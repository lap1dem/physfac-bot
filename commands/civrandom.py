...
def civ_final(message):
    ...
    bot.send_message(
        message.chat.id,
        "*Номер слоту* в лоббі відповідає номеру в круглих дужках.\n*Порядок піку* відповідає номеру слоту.\n*Порядок банів*: гравець з першим слотом банить гравцю з другим слотом і т.д.\n",
        parse_mode="Markdown"
    )
